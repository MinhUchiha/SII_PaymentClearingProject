    ...
    function onRequest(context) {
        try{
            ...
            if (request.method === http.Method.GET) {
                ...
                labelNumber.defaultValue = "<span style='margin-left: 52px'>取込件数&nbsp;&nbsp;&nbsp;:</span>";
                labelNumber.label = '';
                ...
                if(status == 2){
                    textStatus.defaultValue = "<span style='float: left; width: 500px;'>取込失敗</span>";
                }else{
                    textStatus.defaultValue = "<span style='float: left; width: 500px;'>正常取込</span>";
                }
                textStatus.label = '';
